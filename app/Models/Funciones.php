...
class Funciones {
	...
	public static function fURL_Public() {
        $url_public = base_path()."\public";
        //$url_public = "";
		//$url_public = "/var/www/vhosts/t-presto.com.pe/httpdocs/sistema";
        return $url_public;
    }

    public static function fURL_Dominio() {
        $dominio = "http://www.tpresto.local";
        //$dominio = "https://sistema.t-presto.com.pe";
        return $dominio;
    }
